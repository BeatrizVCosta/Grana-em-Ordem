            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @if ($categories->isEmpty())
                        <p>Você ainda não tem categorias registradas.</p>
                    @else
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('categories.destroy', $category) }}" method="POST" class="inline ml-4">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Tem certeza que deseja excluir esta categoria? Isso pode afetar transações vinculadas.');">Excluir</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
